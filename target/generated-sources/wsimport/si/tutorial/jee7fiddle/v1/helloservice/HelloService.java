 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://tutorial.si/jee7fiddle/v1/HelloService/", wsdlLocation = "http://127.0.0.1:8080/jee7fiddle-0.0.1-SNAPSHOT/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://tutorial.si/jee7fiddle/v1/HelloService/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8080/jee7fiddle-0.0.1-SNAPSHOT/HelloService?wsdl");
    ...
    public IHelloService getHelloServicePort() {
        return super.getPort(new QName("http://tutorial.si/jee7fiddle/v1/HelloService/", "HelloServicePort"), IHelloService.class);
    }
    ...
    public IHelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tutorial.si/jee7fiddle/v1/HelloService/", "HelloServicePort"), IHelloService.class, features);
    }
