 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://ws.jee7fiddle.tutorial.si/", wsdlLocation = "http://127.0.0.1:8080/jee7fiddle-0.0.1-SNAPSHOT/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://ws.jee7fiddle.tutorial.si/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://ws.jee7fiddle.tutorial.si/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.jee7fiddle.tutorial.si/", "HelloServicePort"), HelloService.class, features);
    }
